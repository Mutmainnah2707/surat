                                    ...
                                    <div class="col-lg-12 col-sm-12" style="overflow-x:auto;">
                                        <table class="table table-xs table-responsive table-striped table-bordered" style="width: 100%;">
                                            ...
                                            foreach ($lampiran->result() as $baris) { ?>
                                                <tr>
                                                    <td><a href="https://docs.google.com/viewerg/viewer?url=localhost/lampiran/surat_masuk/<?php echo $baris->nama_berkas; ?>" target="_blank" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-eye-open"></span><b>&nbsp; Preview File</b></a></td>
