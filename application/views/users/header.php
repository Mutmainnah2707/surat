...
// Ensure that $this->uri->segment(1), $this->uri->segment(2), and $this->uri->segment(3) are not null
...
<head>
	...
	<link rel="icon" type="image/png" href="foto/logoUA.png">
